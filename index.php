...
<div id="about" class="container_wapper">
    <div class="container-fluid">
        <h1>About This Page</h1>
                    ...
                    <p>This blog offers up-to-date insights on emerging and trending technologies. 
                        Users can share honest feedback, contribute to enhancing company culture,
                        and explore valuable career-related information. Additionally, every user has the opportunity to share their unique perspectives on new tech developments.</p>
                </div>
...
<div id="contact" class="container_wapper">
    <div class="container-fluid">
        ...
        <div class="col-md-4">
            <h2>Contact Info.</h2>
            <p><strong>Email:</strong> info@company.com<br /><strong>Phone:</strong> 010-020-0340<br /><strong>Website:</strong> www.company.com<br /><strong>Address:</strong> 123 Shastra Avenue, Tech Park, Bengaluru 560001, Karnataka, India</p>
...
<div id="footer">
    <div>
        <p id="footer">Copyright &copy; 2023 Company Name</p>
    </div>
</div>
